...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost;Database=DB_ESCUELA;Trust Server Certificate=true;User Id=sa;Password=yourStrong#Password;MultipleActiveResultSets=true");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83F364B5674");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83F40384B78");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83F3D4CB3BC");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83F906813C7");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC7F3321A8B");
